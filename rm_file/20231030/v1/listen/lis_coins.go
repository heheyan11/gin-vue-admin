...
// CreateCoins 创建coin配置
// @Tags Coins
// @Summary 创建coin配置
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body listen.Coins true "创建coin配置"
...
// DeleteCoins 删除coin配置
// @Tags Coins
// @Summary 删除coin配置
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body listen.Coins true "删除coin配置"
...
// UpdateCoins 更新coin配置
// @Tags Coins
// @Summary 更新coin配置
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body listen.Coins true "更新coin配置"
...
// FindCoins 用id查询coin配置
// @Tags Coins
// @Summary 用id查询coin配置
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query listen.Coins true "用id查询coin配置"
...
// GetCoinsList 分页获取coin配置列表
// @Tags Coins
// @Summary 分页获取coin配置列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query listenReq.CoinsSearch true "分页获取coin配置列表"
