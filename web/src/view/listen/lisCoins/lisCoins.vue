<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="每张价值" prop="zhang" width="120" />
        <el-table-column align="left" label="精度" prop="decimal" width="120" />
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="130px">
            ...
            <el-form-item label="每张价值:"  prop="zhang" >
              <el-input v-model="formData.zhang" :clearable="true"  placeholder="请输入每张价值" />
            </el-form-item>
            <el-form-item label="精度:"  prop="decimal" >
              <el-input v-model="formData.decimal" :clearable="true"  placeholder="请输入精度" />
            </el-form-item>
          </el-form>
      </el-scrollbar>
      <template #footer>
    ...
    <el-dialog v-model="detailShow" style="width: 800px" lock-scroll :before-close="closeDetailShow" title="查看详情" destroy-on-close>
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
                ...
                <el-descriptions-item label="每张价值">
                        {{ formData.zhang }}
                </el-descriptions-item>
